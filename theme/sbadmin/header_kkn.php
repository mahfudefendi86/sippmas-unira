    ...
    <ul class="navbar-nav navbar-sidenav" id="MenuAccordion" style="overflow-y:auto;" >
      ...
      <li class="nav-item" >
        ...
        <ul class="sidenav-second-level collapse <?php echo ($this->session->tempdata('active_link')=="master")?"show ":"";?>" id="master_data">
          <li>
            <a href="<?php echo site_url('peserta_kkn');?>">Data Peserta KKN</a>
          </li>
          <li>
            <a href="<?php echo site_url('reviewer');?>">Data Tahun KKN</a>
          </li>
          <li>
            <a href="<?php echo site_url('reviewer');?>">Data Tempat</a>
          </li>
          <li>
            <a href="<?php echo site_url('fakultas');?>">Data Kelompok</a>
          </li>
        </ul>
      </li>
