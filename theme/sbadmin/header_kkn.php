    ...
    <ul class="navbar-nav navbar-sidenav" id="MenuAccordion" style="overflow-y:auto;" >
      ...
      <li class="nav-item" >
        ...
        <ul class="sidenav-second-level collapse <?php echo ($this->session->tempdata('active_link') == "master") ? "show " : ""; ?>" id="master_data">
          <li <?php echo ($this->session->tempdata('active_sublink') == "peserta_kkn") ? 'class="aktif"' : ''; ?>>
            <a href="<?php echo site_url('peserta/kkn'); ?>">Data Peserta KKN</a>
          </li>
          <li <?php echo ($this->session->tempdata('active_sublink') == "tahun_ajaran") ? 'class="aktif"' : ''; ?>>
            <a href="<?php echo site_url('tahun_ajaran/kkn'); ?>">Data Tahun KKN</a>
          </li>
          <li <?php echo ($this->session->tempdata('active_sublink') == "tempat_kkn") ? 'class="aktif"' : ''; ?>>
            <a href="<?php echo site_url('tempat/kkn'); ?>">Data Tempat</a>
          </li>
          <li <?php echo ($this->session->tempdata('active_sublink') == "kelompok_kkn") ? 'class="aktif"' : ''; ?>>
            <a href="<?php echo site_url('kelompok/kkn'); ?>">Data Kelompok</a>
          </li>
        </ul>
      </li>
