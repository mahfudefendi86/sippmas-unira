...
<div class="card p-3 mb-3">
	<form class="form-horizontal" role="form" name="formsearch_capaian_buku" id="search_capaian_buku" action="<?php echo site_url("capaian_buku/capaian_buku_search") ;?>" method="post" >
...
$(document).ready(function(){
	...
	$("#search_capaian_buku").validate({

		
		submitHandler: function() {
			var frm=$("#search_capaian_buku");
			$.ajax({
				url       : frm.attr("action"),
