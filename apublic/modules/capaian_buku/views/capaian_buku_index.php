...
$("#add").click(function(){
	$.ajax({
			url       : "<?php echo site_url('capaian_buku/capaian_buku_add');?>",
			dataType  : "html",
			beforeSend: function(){
						  $("#ajax_loader").fadeIn(100);
			},
			success   : function(data){
						$("#ajax_loader").fadeOut(100);
						$("#modalTitle").html("<h4>Tambah Data Capaian_buku</h4>");
...
$("#search").click(function(){
	$.ajax({
			url       : "<?php echo site_url('capaian_buku/capaian_buku_search');?>",
			dataType  : "html",
			beforeSend: function(){
						  $("#ajax_loader").fadeIn(100);
			},
			success   : function(data){
						$("#dataview_modal").html(data);
						$("#modalTitle").html("<h4>Cari Data Capaian_buku</h4>");
						$("#modalView").modal("show");
						$("#ajax_loader").fadeOut(100);
			}
		});
