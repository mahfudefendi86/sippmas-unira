...
var link="<?php echo site_url('skema/skema_show');?>/0";
...
function switch_icon(cls){
	...
	$("#add").click(function(){
		$.ajax({
				url       : "<?php echo site_url('skema/skema_add');?>",
				dataType  : "html",
				beforeSend: function(){
							  $("#ajax_loader").fadeIn(100);
				},
				success   : function(data){
							$("#ajax_loader").fadeOut(100);
							$("#modalTitle").html("<h4>Tambah Data Skema</h4>");
	...
	$("#search").click(function(){
		$.ajax({
				url       : "<?php echo site_url('skema/skema_search');?>",
				dataType  : "html",
				beforeSend: function(){
							  $("#ajax_loader").fadeIn(100);
				},
				success   : function(data){
							$("#dataview_modal").html(data);
							$("#modalTitle").html("<h4>Cari Data Skema</h4>");
							$("#modalView").modal("show");
							$("#ajax_loader").fadeOut(100);
				}
			});
