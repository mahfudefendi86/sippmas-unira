...
<div class="card p-3 mb-3">
	<form class="form-horizontal" role="form" name="formsearch_nilairev" id="search_nilairev" action="<?php echo site_url("nilairev/nilairev_search") ;?>" method="post" >
...
$(document).ready(function(){
	...
	$("#search_nilairev").validate({

		
		submitHandler: function() {
			var frm=$("#search_nilairev");
			$.ajax({
				url       : frm.attr("action"),
