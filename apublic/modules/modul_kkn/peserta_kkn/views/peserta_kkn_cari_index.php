...
<div class="row my-2">
    <div class="col-md-4 col-sm-12 mb-1">
        <div class="input-group input-group-sm mb-2">
            ...
            <select name="slct_row" id="slct_row" class="form-control custom-control-sm"
                onchange="reload_data_peserta_kkn();">
...
<div class="plot" style="display: none">
    <tr>
        <td colspan="10">
            <div class="col-xs-5">
                <!-- <select name="list_peserta" id="list_peserta_arr" class="form-control" size="3" multiple="multiple">
				</select> -->
                <table class="table table-sm table-hover table-bordered table-striped">
                    ...
                    <tbody name="list_peserta_arr" id="list_peserta_arr">
                        <!-- <tr id="no_data">
...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="Modal label" aria-hidden="true"
    id="modalView_peserta_kkn" data-backdrop="static">
...
function reload_data_peserta_kkn(url) {
    ...
    $.ajax({
        ...
        dataType: "html",
        data: "row=" + row + "&action=cari&cari=" + cari + "&sortby=" + sort_field + "&sort=" + sort_index,
        beforeSend: function() {
...
function get_selected_list() {
    let opt = $("#list_peserta_arr").find("tr");
    return opt;
}

$("#modalView").on("shown.bs.modal", function() {
    if (typeof get_current_list != "undefined") {
        let x = $("#list_peserta_arr").find("tr");
        let curr = get_current_list();
        if (x.length == 0) {
            $("#list_peserta_arr").append(curr);
        }
    }
})

// $("#modalView").on("hidden.bs.modal", function(){
// 	//$("#list_peserta").find("tr[id=no_data]").remove();
