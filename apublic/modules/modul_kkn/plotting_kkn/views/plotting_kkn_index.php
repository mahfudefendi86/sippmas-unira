<div class="row">
   ...
   <div class="col-sm-12 col-md-5">
      <div class="row justify-content-md-center">
         <a id="add" title="Tambah Daftar Plotting_kkn" ><button class="btn btn-primary btn-sm ml-3 my-1"><span class="fa fa-plus"></span> Tambah Data</button></a>
	...
	<div class="col-md-4 col-sm-12 mb-1">
      <div class="input-group mb-2">
        <div class="input-group-prepend">
         ...
         <select name="slct_row" id="slct_row" class="form-control" onchange="reload_data_plotting_kkn();">
...
setTimeout("reload_data_plotting_kkn();",1);

var linkPage="<?php echo site_url('plotting_kkn/plotting_kkn_show'); ?>/0";
...
function reload_data_plotting_kkn(url){
...
$("#add").click(function(){
	$.ajax({
		url       : "<?php echo site_url('plotting_kkn/plotting_kkn_add'); ?>",
		dataType  : "html",
		beforeSend: function(){
					  $("#ajax_loader").fadeIn(100);
		},
		success   : function(data){
					$("#ajax_loader").fadeOut(100);
					$("#modalTitle").html("<h4>Tambah Data Plotting Peserta KKN</h4>");
