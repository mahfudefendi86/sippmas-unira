<div class="row">
    ...
    <div class="col-sm-12 col-md-5">
        <div class="row justify-content-md-center">
            <a id="add" title="Tambah Daftar Tahun_ajaran"><button class="btn btn-primary btn-sm ml-3 my-1"><span
...
<div class="row my-2">
    <div class="col-md-4 col-sm-12 mb-1">
        <div class="input-group mb-2">
            ...
            <select name="slct_row" id="slct_row" class="form-control" onchange="reload_data_tahun_ajaran();">
...
setTimeout("reload_data_tahun_ajaran();", 1);

var linkPage = "<?php echo site_url('tahun_ajaran/tahun_ajaran_show'); ?>/0";
...
function reload_data_tahun_ajaran(url) {
...
$("#add").click(function() {
    $.ajax({
        url: "<?php echo site_url('tahun_ajaran/tahun_ajaran_add'); ?>",
        dataType: "html",
        beforeSend: function() {
            $("#ajax_loader").fadeIn(100);
        },
        success: function(data) {
            $("#ajax_loader").fadeOut(100);
            $("#modalTitle").html("<h4>Tambah Data Tahun Ajaran</h4>");
