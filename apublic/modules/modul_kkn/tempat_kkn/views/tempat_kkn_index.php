<div class="row">
    ...
    <div class="col-sm-12 col-md-5">
        <div class="row justify-content-md-center">
            <a id="add" title="Tambah Daftar Tempat_kkn"><button class="btn btn-primary btn-sm ml-3 my-1"><span
...
<div class="row my-2">
    <div class="col-md-4 col-sm-12 mb-1">
        <div class="input-group mb-2">
            ...
            <select name="slct_row" id="slct_row" class="form-control" onchange="reload_data_tempat_kkn();">
...
setTimeout("reload_data_tempat_kkn();", 1);

var linkPage = "<?php echo site_url('tempat_kkn/tempat_kkn_show'); ?>/0";
...
function reload_data_tempat_kkn(url) {
...
$("#add").click(function() {
    $.ajax({
        url: "<?php echo site_url('tempat_kkn/tempat_kkn_add'); ?>",
        dataType: "html",
        beforeSend: function() {
            $("#ajax_loader").fadeIn(100);
        },
        success: function(data) {
            $("#ajax_loader").fadeOut(100);
            $("#modalTitle").html("<h4>Tambah Data Tempat KKN</h4>");
