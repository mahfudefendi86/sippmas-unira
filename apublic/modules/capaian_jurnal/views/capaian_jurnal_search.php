...
<div class="card p-3 mb-3">
	<form class="form-horizontal" role="form" name="formsearch_capaian_jurnal" id="search_capaian_jurnal" action="<?php echo site_url("capaian_jurnal/capaian_jurnal_search") ;?>" method="post" >
...
$(document).ready(function(){
	...
	$("#search_capaian_jurnal").validate({

		
		submitHandler: function() {
			var frm=$("#search_capaian_jurnal");
			$.ajax({
				url       : frm.attr("action"),
