<?php if(isset($penelitian)){
    ...
    //var_dump($format);
?>
<form action="<?php echo site_url('cetak_pdf/save_tgjb') ;?>" method="post" />
<input type="hidden" name="id_ctk" id="id_ctk" value="<?php echo (!$is_edit)? "" :$conten->id_ctk;?>" />
<input type="hidden" name="id_penelitian" id="id_penelitian" value="<?php echo  (!$is_edit)? $penelitian->id_penelitian :$conten->id_penelitian;?>" />
<div class="card">
    <div class="card-body">
        ...
        <span class="float-md-right">
            <button type="submit" class="btn btn-sm btn-success" onclick="printDiv('section')"><i class="fa fa-save"></i> Simpan</button>
            <a target="_blank" href="<?php echo site_url('cetak_pdf/cetak_tgjb/'.$penelitian->id_penelitian);?>" class="btn btn-sm btn-primary" ><i class="fa fa-file-pdf-o"></i> Cetak PDF</a>
