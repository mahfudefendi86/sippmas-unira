...
<div class="card p-3 mb-3">
	<form class="form-horizontal" role="form" name="formsearch_prodi" id="search_prodi" action="<?php echo site_url("prodi/prodi_search") ;?>" method="post" >
...
<hr/>
		...
		$(document).ready(function(){
			 ...
			 $("#search_prodi").validate({
			 
				  
				  submitHandler: function() {
					var frm=$("#search_prodi");
					$.ajax({
						url       : frm.attr("action"),
