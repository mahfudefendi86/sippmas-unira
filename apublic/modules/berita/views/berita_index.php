<div class="row">
   ...
   <div class="col-sm-12 col-md-5">
      <div class="float-md-right">
         <a id="add" href="<?php echo site_url('berita/berita_add');?>" title="Tambah Daftar Berita" ><button class="btn btn-primary btn-sm ml-3 my-1"><span class="fa fa-plus"></span> Tambah Berita</button></a>
...
function reload_data(url){
	...
	if(url == null || url == undefined){
		seturl="<?php echo site_url('berita/berita_show');?>/0";
	}else{
		seturl=url;
	};
	$.ajax({
