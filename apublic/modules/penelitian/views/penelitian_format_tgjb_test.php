...
?>
    <page size="A4" id="section">
        ...
        <p>Yang bertanda tangan di bawah ini :<br/><br/>
             <table>
                 <tr><td>Nama</td><td >: <?php echo $penelitian->nama;?></td></tr>
                 <tr><td >Alamat</td><td >: <?php echo ucwords(strtolower($penelitian->alamat.' '.$penelitian->desa.' '.$penelitian->kecamatan.' '.$penelitian->kotakab));?></td></tr>
            </table>
        <br/><br/>
...
<button onclick="demoFromHTML();">download</button>
<script src="<?php echo base_url();?>theme/<?php echo $this->config->item('theme');?>/vendor/jquery/jquery.min.js"></script>
<script src="<?php echo base_url();?>asset/addon/jspdf/dist/jspdf.debug.js" ></script>
<!-- <script src="<?php echo base_url();?>asset/addon/jspdf/jspdf.js" ></script> -->
<!-- <script src="<?php echo base_url();?>asset/addon/jspdf/jspdf.plugin.from_html.js" ></script>
<script src="<?php echo base_url();?>asset/addon/jspdf/jspdf.plugin.standard_fonts_metrics.js" ></script>
<script src="<?php echo base_url();?>asset/addon/jspdf/jspdf.plugin.split_text_to_size.js" ></script> -->
<script>
function demoFromHTML() {
    var doc = new jsPDF('p', 'pt', 'A4');

    doc.fromHTML($('#section').get(0), 25, 25, {
	'width': 800
});
