	...
	<td>
		<div class="dropdown">
		  ...
		  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
			  	<a title="Ubah data catatan" data-toggle="tooltip" class="dropdown-item text-primary" href="<?php echo site_url('catatan/show/'.$dataview->id_penelitian);?>"><i class="fa fa-edit"></i> Catatan Harian</a>
