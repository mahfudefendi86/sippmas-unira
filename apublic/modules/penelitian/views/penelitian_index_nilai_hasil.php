...
<input type="hidden" name="status" id="status" value="PRT" />
...
function reload_data(url){
	...
	$.ajax({
		...
		type         : "POST",
		dataType     : "html",
		data         : "row="+row+"&anggaran="+anggaran+"&cari="+cari+"&status="+status+"&link=hasil_nilai",
		beforeSend	: function(){
...
$("#search").click(function(){
	$.ajax({
			url       : "<?php echo site_url('penelitian/penelitian_search');?>",
			dataType  : "html",
			beforeSend: function(){
						  $("#ajax_loader").fadeIn(100);
			},
			success   : function(data){
						...
						$("#modalTitle").html("<h4>Cari Data Penelitian</h4>");
