...
<tr id="tr_<?php echo $dataview->id_penelitian;?>"  style="background:<?php echo ($no%2==0)?'#f4f6f9':'';?>">
	...
	<td>
		<button type="button" rel="<?php echo $dataview->id_penelitian;?>" class="upload tip btn btn-success btn-sm" title="Unggah Laporan Kemajuan"><i class="fa fa-upload"></i></button>
		<?php
		if($dataview->file_kemajuan > 0){
			echo '<a href="'.site_url('penelitian/unduh_kemajuan/'.$dataview->id_penelitian).'" class="tip btn btn-warning btn-sm" title="Unduh Laporan Kemajuan"><i class="fa fa-download"></i></a>';
		}else{
...
$(document).ready(function(){
	...
	$(".upload").click(function(){
		...
		$.ajax({
				url       : "<?php echo site_url('berkas/berkas_add_kemajuan');?>",
				dataType  : "html",
				type      : "POST",
