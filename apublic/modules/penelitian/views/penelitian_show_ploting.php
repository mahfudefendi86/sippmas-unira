	...
	<td>
		<div class="dropdown">
		  ...
		  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
				<a href="<?php echo site_url('penelitian/penelitian_plot_reviewer/'.$dataview->id_penelitian);?>" class="plot dropdown-item"  title="Plotting Reviwer"><i class="fa fa-user"></i> Plot Reviwer</a>
