...
<div class="card p-3 mb-3">
	<form class="form-horizontal" role="form" name="formsearch_fakultas" id="search_fakultas" action="<?php echo site_url("fakultas/fakultas_search") ;?>" method="post" >
...
<hr/>
		...
		$(document).ready(function(){
			 ...
			 $("#search_fakultas").validate({
			 
				  
				  submitHandler: function() {
					var frm=$("#search_fakultas");
					$.ajax({
						url       : frm.attr("action"),
