...
<div class="card p-3 mb-3">
	<form class="form-horizontal" role="form" name="formsearch_capaian_lain" id="search_capaian_lain" action="<?php echo site_url("capaian_lain/capaian_lain_search") ;?>" method="post" >
...
$(document).ready(function(){
	...
	$("#search_capaian_lain").validate({

		
		submitHandler: function() {
			var frm=$("#search_capaian_lain");
			$.ajax({
				url       : frm.attr("action"),
