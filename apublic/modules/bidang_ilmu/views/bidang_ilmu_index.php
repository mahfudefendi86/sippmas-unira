...
var link="<?php echo site_url('bidang_ilmu/bidang_ilmu_show');?>/0";
...
$("#add").click(function(){
	$.ajax({
			url       : "<?php echo site_url('bidang_ilmu/bidang_ilmu_add');?>",
			dataType  : "html",
			beforeSend: function(){
						  $("#ajax_loader").fadeIn(100);
			},
			success   : function(data){
						$("#ajax_loader").fadeOut(100);
						$("#modalTitle").html("<h4>Tambah Data Bidang Keilmuan</h4>");
...
$("#search").click(function(){
	$.ajax({
			url       : "<?php echo site_url('bidang_ilmu/bidang_ilmu_search');?>",
			dataType  : "html",
			beforeSend: function(){
						  $("#ajax_loader").fadeIn(100);
			},
			success   : function(data){
						$("#dataview_modal").html(data);
						$("#modalTitle").html("<h4>Cari Data Bidang Keilmuan</h4>");
						$("#modalView").modal("show");
						$("#ajax_loader").fadeOut(100);
			}
		});
