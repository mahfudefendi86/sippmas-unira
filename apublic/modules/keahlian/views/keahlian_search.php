...
<div class="card p-3 mb-3">
	<form class="form-horizontal" role="form" name="formsearch_keahlian" id="search_keahlian" action="<?php echo site_url("keahlian/keahlian_search") ;?>" method="post" >

		<div class="form-group row">
			<label class="col-sm-12 col-md-3" for="bi_keahlian">Bidang Keahlian</label>
			<div class="col-sm-12 col-md-9">
				<input type="text" class="form-control" value="" name="bi_keahlian" id="bi_keahlian" placeholder="Bidang Keahlian"   />
			</div>
		</div>
...
<hr/>
		...
		$(document).ready(function(){
			 ...
			 $("#search_keahlian").validate({


				  submitHandler: function() {
					var frm=$("#search_keahlian");
					$.ajax({
						url       : frm.attr("action"),
