...
<div class="card p-3 mb-3">
	<form class="form-horizontal" role="form" name="formsearch_capaian_visiting" id="search_capaian_visiting" action="<?php echo site_url("capaian_visiting/capaian_visiting_search") ;?>" method="post" >
...
$(document).ready(function(){
	...
	$("#search_capaian_visiting").validate({

		
		submitHandler: function() {
			var frm=$("#search_capaian_visiting");
			$.ajax({
				url       : frm.attr("action"),
