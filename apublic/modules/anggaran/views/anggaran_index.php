...
var link="<?php echo site_url('anggaran/anggaran_show');?>/0";
...
function reload_data(url){
	...
	$("#add").click(function(){
		$.ajax({
				url       : "<?php echo site_url('anggaran/anggaran_add');?>",
				dataType  : "html",
				beforeSend: function(){
							  $("#ajax_loader").fadeIn(100);
				},
				success   : function(data){
							$("#ajax_loader").fadeOut(100);
							$("#modalTitle").html("<h4>Tambah Data Anggaran</h4>");
	...
	$("#search").click(function(){
		$.ajax({
				url       : "<?php echo site_url('anggaran/anggaran_search');?>",
				dataType  : "html",
				beforeSend: function(){
							  $("#ajax_loader").fadeIn(100);
				},
				success   : function(data){
							$("#dataview_modal").html(data);
							$("#modalTitle").html("<h4>Cari Data Anggaran</h4>");
							$("#modalView").modal("show");
							$("#ajax_loader").fadeOut(100);
				}
			});
