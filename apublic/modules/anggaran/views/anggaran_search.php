...
<div class="card p-3 mb-3">
	<form class="form-horizontal" role="form" name="formsearch_anggaran" id="search_anggaran" action="<?php echo site_url("anggaran/anggaran_search") ;?>" method="post" >

				<div class="form-group row">
					<label class="col-sm-12 col-md-3" for="agr_tahun_anggaran">Tahun Anggaran</label>
...
<hr/>
		...
		$(document).ready(function(){
			 ...
			 $("#search_anggaran").validate({
			 
				  
				  submitHandler: function() {
					var frm=$("#search_anggaran");
					$.ajax({
						url       : frm.attr("action"),
