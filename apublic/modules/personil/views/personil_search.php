...
<div class="card p-3 mb-3">
	<form class="form-horizontal" role="form" name="formsearch_personil" id="search_personil" action="<?php echo site_url("personil/personil_search") ;?>" method="post" >

				<div class="form-group row">
					<label class="col-sm-12 col-md-3" for="psn_id_penelitian">id_penelitian</label>
					<div class="col-sm-12 col-md-9">
						<input type="text" class="form-control" value="<?php echo (!$is_edit) ? '' : $personil->id_penelitian;?>" name="psn_id_penelitian" id="psn_id_penelitian" placeholder="id_penelitian"   />
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-12 col-md-9">
						<input type="text" class="form-control" value="<?php echo (!$is_edit) ? '' : $personil->jenis_personil;?>" name="psn_jenis_personil" id="psn_jenis_personil" placeholder="Jenis Personil"   />
					</div>
				</div>
...
$(document).ready(function(){
	...
	$("#search_personil").validate({

		
		submitHandler: function() {
			var frm=$("#search_personil");
			$.ajax({
				url       : frm.attr("action"),
