...
<div class="card p-3 mb-3">
	<form class="form-horizontal" role="form" name="formsearch_capaian_invitasi" id="search_capaian_invitasi" action="<?php echo site_url("capaian_invitasi/capaian_invitasi_search") ;?>" method="post" >
...
$(document).ready(function(){
	...
	$("#search_capaian_invitasi").validate({

		
		submitHandler: function() {
			var frm=$("#search_capaian_invitasi");
			$.ajax({
				url       : frm.attr("action"),
