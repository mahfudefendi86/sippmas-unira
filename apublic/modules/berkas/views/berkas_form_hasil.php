...
<!-- <input type="hidden" class="form-control" value="<?php echo (!$is_edit) ? 'hasil' : $berkas->identifikasi_berkas;?>" name="bks_identifikasi_berkas" id="bks_identifikasi_berkas" placeholder="identifikasi_berkas"   /> -->
...
<input type="hidden" name="command" id="command" value="DELETE|INSERT" />
	...
	<div class="form-group row">
		<label class="col-sm-12 col-md-3" for="bks_identifikasi_berkas">Jenis Dokumen <span class="text-danger">*</span></label>
		<div class="col-sm-12 col-md-9">
			<select class="custom-select" name="bks_identifikasi_berkas" id="bks_identifikasi_berkas" placeholder="Jenis Dokumen">
				<option value="">= Pilih Jenis Dokumen =</option>
				<?php
					$d=array('artikel'=>"Artikel Ilmiah",'borang'=>"Borang Capaian Hasil Penelitian",'poster'=>"Poster",'profil'=>"Profil Peneliti");
					foreach ($d as $key => $value) {
						if($key==((!$is_edit) ? '' : $berkas->identifikasi_berkas)){
 ...
 $("#formberkas").validate({
			...
			wrapper: "span",
	  		rules:{
				...
				bks_identifikasi_berkas:{required: true,}
 			 },
			 messages:{
 				userfile: {
				...
				bks_identifikasi_berkas:" Pilih jenis dokumen yang akan anda Unggah..."
 			},
