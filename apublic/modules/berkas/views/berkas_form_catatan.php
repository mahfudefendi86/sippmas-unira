...
<input type="hidden" class="form-control" value="<?php echo (!$is_edit) ? $catatan->id_penelitian : $berkas->id_penelitian;?>" name="id_penelitian" id="id_penelitian" placeholder="id_penelitian"   />
<input type="hidden" class="form-control" value="<?php echo (!$is_edit) ? 'catatan' : $berkas->identifikasi_berkas;?>" name="bks_identifikasi_berkas" id="bks_identifikasi_berkas" placeholder="identifikasi_berkas"   />
<input type="hidden" class="form-control" value="<?php echo (!$is_edit) ? $catatan->id_catatan : $berkas->identifikasi_id;?>" name="bks_identifikasi_id_berkas" id="bks_identifikasi_id_berkas" placeholder="identifikasi_id_berkas"   />
