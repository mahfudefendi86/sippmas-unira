...
<input type="hidden" class="form-control" value="<?php echo (!$is_edit) ? 'akhir' : $berkas->identifikasi_berkas;?>" name="bks_identifikasi_berkas" id="bks_identifikasi_berkas" placeholder="identifikasi_berkas"   />
